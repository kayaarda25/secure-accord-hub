export const de: Record<string, string> = {
  ...
  "users.inviteNew": "Neuen Benutzer einladen",
  "users.inviteDesc": "Senden Sie eine Einladung per E-Mail mit den gewünschten Berechtigungen.",
  "users.emailReq": "E-Mail-Adresse *",
  "users.department": "Abteilung",
  "users.position": "Position (nur informativ)",
  "users.permissions": "Berechtigungen",
  "users.cancel": "Abbrechen",
  "users.sendInvite": "Einladung senden",
  "users.sending": "Wird gesendet...",
  "users.registered": "Registrierte Benutzer",
  "users.inSystem": "Benutzer im System",
  "users.name": "Name",
  "users.email": "E-Mail",
  "users.status": "Status",
  ...
  "users.manageInvites": "Versendete Einladungen verwalten",
  "users.createdAt": "Erstellt am",
  "users.pending": "Ausstehend",
  "users.accepted": "Akzeptiert",
  "users.cancelled": "Abgebrochen",
  "users.expired": "Abgelaufen",
  "users.fourEyes": "Vier-Augen-Prinzip",
  "users.fourEyesDesc": "Für jede Aktion können zwei definierte Mitarbeiter festgelegt werden, die gemeinsam freigeben müssen.",
  "users.activate": "Aktivieren",

  // Tasks
  "tasks.total": "Gesamte Aufgaben",
  ...
  "tasks.createDesc": "Fügen Sie eine neue Aufgabe zu Ihrer Liste hinzu",
  "tasks.titleReq": "Titel *",
  "tasks.dueDate": "Fälligkeitsdatum",
  "tasks.priority": "Priorität",
  "tasks.low": "Niedrig",
  "tasks.normal": "Normal",
  "tasks.high": "Hoch",
  "tasks.critical": "Kritisch",
  "tasks.desc": "Beschreibung",
  "tasks.recurring": "Wiederkehrende Aufgabe",
  "tasks.repeat": "Wiederholen",
  "tasks.daily": "Täglich",
  "tasks.weekly": "Wöchentlich",
  "tasks.monthly": "Monatlich",
  "tasks.until": "Bis",
  "tasks.share": "Teilen mit",
  "tasks.cancel": "Abbrechen",
  "tasks.createBtn": "Aufgabe erstellen",
  "tasks.noTasks": "Keine Aufgaben gefunden",
  "tasks.noTasksDesc": "Erstellen Sie Ihre erste Aufgabe, um zu beginnen.",
