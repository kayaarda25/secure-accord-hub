...
export default function Security() {
  ...
  const handleUpdateTimeout = async (minutes: number) => {
    ...
    if (error) {
      ...
      setSettings({ ...settings, session_timeout_minutes: minutes });
      toast({ title: "Gespeichert", description: "Session-Timeout wurde aktualisiert" });
    }
  };
  ...
  const handleTerminateSession = async (sessionId: string) => {
    ...
    if (error) {
      toast({ title: "Fehler", description: "Session konnte nicht beendet werden", variant: "destructive" });
    } else {
      setSessions(sessions.filter((s) => s.id !== sessionId));
      toast({ title: "Session beendet", description: "Die Session wurde erfolgreich beendet" });
    }
  };
  ...
  const handleTerminateAllSessions = async () => {
    ...
    if (error) {
      toast({ title: "Fehler", description: "Sessions konnten nicht beendet werden", variant: "destructive" });
    } else {
      setSessions([]);
      toast({ title: "Alle Sessions beendet", description: "Alle anderen Sessions wurden beendet" });
    }
  };
  ...
  return (
    <Layout title="Sicherheit" subtitle="Sicherheitseinstellungen und Sessions verwalten">
